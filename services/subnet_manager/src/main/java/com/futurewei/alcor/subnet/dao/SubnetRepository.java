...
public class SubnetRepository implements ICacheRepository<SubnetState> {
    ...
    public SubnetRepository (CacheFactory cacheFactory) {
        cache = cacheFactory.getCache(SubnetState.class);
    }
    ...
    @Override
    public Map<String, SubnetState> findAllItems() throws CacheException {
        return cache.getAll();
    }

    @Override
    public void addItem(SubnetState routeState) throws CacheException {
