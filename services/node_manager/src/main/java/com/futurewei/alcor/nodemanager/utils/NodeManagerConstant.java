...
public class NodeManagerConstant {
    ...
    public static final String NODE_EXCEPTION_JSON_EMPTY = "The node json is empty";
    ...
    public static final String NODE_CONTENT_INVALID_EXCEPTION = "Invalid node content ";
}
