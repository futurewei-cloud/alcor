...
public class SubnetManagerProxy {
    ...
    public SubnetManagerProxy(String projectId) {
        this.subnetManagerRestClient = SpringContextUtil.getBean(SubnetManagerRestClient.class);;
    ...
    public SubnetEntity getSubnetEntity(Object args) throws Exception {
        ...
        if (subnetWebJson == null || subnetWebJson.getSubnet() == null) {
            System.out.println("Get subnet entity failed");;
        }
