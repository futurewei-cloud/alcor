...
//    };
    ...
    public static HostInfo[] transitSwitchHostsForSubnet1 = {
            new HostInfo("subnet1-transit-switch1", "transit switch1 host for subnet1", AppConfig.TRANSIT_SWITCH_1_IP, AppConfig.TRANSIT_SWITCH_1_MAC, AppConfig.gRPCServerPortForSubnet1[4]),
            new HostInfo("subnet1-transit-switch2", "transit switch2 host for subnet1", AppConfig.TRANSIT_SWITCH_2_IP, AppConfig.TRANSIT_SWITCH_2_MAC, AppConfig.gRPCServerPortForSubnet1[5])
    };

    public static HostInfo[] transitSwitchHostsForSubnet2 = {
            new HostInfo("subnet2-transit-switch1", "transit switch1 host for subnet2", AppConfig.TRANSIT_SWITCH_3_IP, AppConfig.TRANSIT_SWITCH_3_MAC),
            new HostInfo("subnet2-transit-switch2", "transit switch2 host for subnet2", AppConfig.TRANSIT_SWITCH_4_IP, AppConfig.TRANSIT_SWITCH_4_MAC)
    };
...
//    };
    ...
    public static HostInfo[] epHostForSubnet1 = {
            new HostInfo("subnet1-ep1", "ep1 host", AppConfig.EP1_HOST_IP, AppConfig.EP1_HOST_MAC, AppConfig.gRPCServerPortForSubnet1[0]),
            new HostInfo("subnet1-ep2", "ep2 host", AppConfig.EP2_HOST_IP, AppConfig.EP2_HOST_MAC, AppConfig.gRPCServerPortForSubnet1[1]),
            new HostInfo("subnet1-ep3", "ep3 host", AppConfig.EP3_HOST_IP, AppConfig.EP3_HOST_MAC, AppConfig.gRPCServerPortForSubnet1[2]),
            new HostInfo("subnet1-ep4", "ep4 host", AppConfig.EP4_HOST_IP, AppConfig.EP4_HOST_MAC, AppConfig.gRPCServerPortForSubnet1[3]),
    };

    public static HostInfo[] epHostForSubnet2 = {
            new HostInfo("subnet2-ep1", "ep5 host", AppConfig.EP5_HOST_IP, AppConfig.EP5_HOST_MAC),
            new HostInfo("subnet2-ep2", "ep6 host", AppConfig.EP6_HOST_IP, AppConfig.EP6_HOST_MAC),
            new HostInfo("subnet2-ep3", "ep7 host", AppConfig.EP7_HOST_IP, AppConfig.EP7_HOST_MAC),
            new HostInfo("subnet2-ep4", "ep8 host", AppConfig.EP8_HOST_IP, AppConfig.EP8_HOST_MAC),
    };
