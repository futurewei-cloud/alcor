...
The top-down communication channel from Controllers to Agents can be used in many scenarios which may require low E2E latency for network configuration update:
...
The contract between the Control Agents and Network Controllers for the top-down channel is as follows:
