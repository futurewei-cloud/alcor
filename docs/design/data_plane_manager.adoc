...
+
____
Request: /goalstate/{goalstates}", "/v4/{goalstates}
____
* {blank}
+
____
...
http://localhost:8080/goalstate/3dda2801-d675-4688-a63f-dcda8d327f50
...
{
"code":200
"desc":"port created successfully"
}
...
+
____
Request: /goalstate/{vpcid}/{hostid}/{goalstateid}", "/v4/goalstate/{vpcid}/{hostid}/{goalstateid}
____
* {blank}
+
____
Request Parameter: 
____
** @PathVariable String goalstateid, @PathVariable String hostid,@PathVariable String vpcid
* {blank}
+
____
...
http://localhost:8080/goalstate/9192a4d4-ffff-4ece-b3f0-8d36e3d88038/ephost3/3dda2801-d675-4688-a63f-dcda8d327f50
...
{
"code":200
"desc":"port 3dda2801-d675-4688-a63f-dcda8d327f50 on host ephost3 deleted in vpc 9192a4d4-ffff-4ece-b3f0-8d36e3d88038  successfully"
}
...
{
"code":200
"desc":"port updated successfully"
}
...
{
"code":200
"desc":"bulk ports for vpc 9192a4d4-ffff-4ece-b3f0-8d36e3d88038 and 9192a4d4-ffff-4ece-b3f0-8d36e3d88039 created successfully"
}
...
{
"code":200
"desc":"bulk ports for vpc 9192a4d4-ffff-4ece-b3f0-8d36e3d88038 and 9192a4d4-ffff-4ece-b3f0-8d36e3d88039 deleted successfully"
}
