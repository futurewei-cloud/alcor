...
|/goalstate/{gsinfo}
|Goal State list
<<Create_GoalState,[sample]>>

|Delete Port by GoalState
|DELETE
|/goalstate/{gsinfo}
|GOAL State
<<Delete_Goalstate,[sample]>>

|Update Port by GoalState
|PUT
...
|/goalstate/{gsinfo}
|Goal State list
<<BULK_Create_GoalState,[sample]>>

|Bulk Delete Port by GoalState
|DELETE
|/goalstate/{gsinfo}
|GOAL State
<<BULK_Delete_Goalstate,[sample]>>
