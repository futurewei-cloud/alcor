...
____
/project/\{projectid}/goalstates/\{goalstateid},/v4/\{projectid}/goalstates/\{goalstateid}
____
...
http://serverIP:8080/project/3dda2801-d675-4688-a63f-dcda8d327f50/goalstate/f37810eb-7f83-45fa-a4d4-1b31e75399df
...
+
____
Request: /project/\{projectid}/goalstates", "v4/\{projectid}/goalstates
____
* {blank}
+
____
Request Parameter: 
____
** @PathVariable String projectid, @PathVariable String gsid, @RequestBody GoalStateJson resource
* {blank}
+
____
...
http://localhost:8080/project/3dda2801-d675-4688-a63f-dcda8d327f50/goalstates
