...
* Response: elasticip range state
* Normal response codes: 200
* Error response codes: 400, 412, 500
...
* Response: elasticip range state list
* Normal response codes: 200
* Error response codes: 400, 412, 500
