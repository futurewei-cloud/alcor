...
** If input body includes user-defined gateway ip address, this function needs to call Port Manager to create a port using
the specified ip. If there is no user-defined gateway ip, this function use a default gateway ip address to request a port from
Port Manager.
