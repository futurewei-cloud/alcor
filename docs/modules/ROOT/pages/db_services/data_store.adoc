...
** The estimated number of port-related resources (e.g. security groups, ACL, route, DNS records and subnets) is of the same magnitude.
...
and customer-specified fields (e.g. security rules and route).
