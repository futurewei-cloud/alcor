...
|===
|*1 thread* |*32 threads*
|image::p4.png[image,width=276,height=165] |image::p5.png[image,width=262,height=156]
|*56 threads* |*100 threads*
|image::p6.png[image,width=262,height=156] |image::p7.png[image,width=262,height=156]
|*512 threads* |*10800 threads*
|image::p8.png[image,width=262,height=156] |image::p9.png[image,width=262,height=156]
|===
