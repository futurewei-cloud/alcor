...
curl -X GET -H "Content-Type: application/json" http://localhost:9014/nodes
echo "POST, new node"
...
curl -X GET -H "Content-Type: application/json" http://localhost:9014/nodes/9192a4d4-ffff-4ece-b3f0-8d36e3d85002
echo "Update it"
curl -X PUT -H "Content-Type: application/json" http://localhost:9014/nodes/9192a4d4-ffff-4ece-b3f0-8d36e3d85002 --data @json/updateNode.json
